...
class ReaderProfileDetailScreen extends StatelessWidget {
  const ReaderProfileDetailScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _ReaderProfileDetailView(),
    );
  }
}

class _ReaderProfileDetailView extends StatelessWidget {
  const _ReaderProfileDetailView();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ReaderProfileCubit, ReaderProfileState>(
        builder: (context, state) {
          if (state.status == ReaderProfileStatus.loading) {
            return const Center(
                      ...
                      child: SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () => _showConfirmDialog(
                            ...
                            message:
                                l10n.confirmBookNotInterested(book.title),
                            l10n: l10n,
                            onConfirm: () {
                              context
                                  .read<ReaderProfileCubit>()
                          ...
                          icon:
                              const Icon(Icons.not_interested, size: 15),
