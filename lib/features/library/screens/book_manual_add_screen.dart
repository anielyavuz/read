...
class BookManualAddScreen extends StatelessWidget {
  const BookManualAddScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _BookManualAddContent(),
    );
  }
}

class _BookManualAddContent extends StatefulWidget {
  const _BookManualAddContent();

  @override
  State<_BookManualAddContent> createState() => _BookManualAddContentState();
}

class _BookManualAddContentState extends State<_BookManualAddContent> {
